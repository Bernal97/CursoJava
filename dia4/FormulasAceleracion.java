...
package Challenges.dia4;
import java.util.Scanner;
public class FormulasAceleracion {
    ...
    public static void main (String [] args){
        ...
        do{
            ...
            op = teclado.nextInt();
            switch(op){
                case 1: var totalPotencia3 = Math.sqrt(sumaTresPotencia); 
                        System.out.println(totalPotencia3);
                        break;
                case 2: var totalPotencia2 = Math.sqrt(sumaDosPotencia); 
                        System.out.println(totalPotencia2);
                        break;
                case 3: var velMedia = val1 + (val2*val3);
                        System.out.println(velMedia);
                        break;
                        
                case 4: var total1 = (-val2 + Math.sqrt(discriminante))/(val1*2);
